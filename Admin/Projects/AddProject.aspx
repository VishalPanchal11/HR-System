<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddProject.aspx.cs" Inherits="HR_System.Admin.Projects.AddProject" %>
...
<script>
    // dropdown close na ho checkbox pe
    ...
    // selected member names textbox me show
    document.addEventListener('change', function () {
        let names = [];
        document.querySelectorAll('#<%= chkUsers.ClientID %> input[type=checkbox]:checked')
            .forEach(cb => {
                names.push(cb.nextSibling.textContent.trim());
            });
        document.getElementById('txtSelectedMembers').value = names.join(', ');
    });
</script>
